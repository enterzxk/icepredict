#!/bin/bash
# Python 3.9 服务器安装脚本
# 使用方法: bash install_server_py39.sh

set -e

echo "=========================================="
echo "IceGuard AI - Python 3.9 服务器安装"
echo "=========================================="
...
# 安装依赖（使用Python 3.9兼容版本）
echo "安装Python依赖（Python 3.9兼容版本）..."
...
# 检查anthropic库
echo "检查anthropic库..."
python3 -c "import anthropic; print(f'anthropic版本: {anthropic.__version__}')"
